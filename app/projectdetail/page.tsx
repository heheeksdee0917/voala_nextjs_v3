          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                <span dangerouslySetInnerHTML={{ __html: project.overview || 'This project represents our commitment to creating exceptional spaces...' }} />
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <StandardButton onClick={() => router.push('/contact')} variant="outline">
                  Get Your Quote
                </StandardButton>
              </div>
            </motion.div>
